  ...
  render () {
      ...
      datasets: [
        {
          ...
          data: [
            percentages.all_hgvs,
            percentages.buses_and_coaches,
            percentages.cars_and_taxis,
            percentages.pedal_cycles
          ]
        }
      ]
    }
    return (
      <div>
        ...
        <ListSubheader>
          Filters: Annual Average Daily Flow By Direction
        </ListSubheader>
        <Divider />
        <br />
        <Typography variant='body2'>
          Choose a year to see traffic flow data for that year.
        </Typography>
        ...
        <br />
        <Typography variant='body2'>
          Choose an authority to look at traffic flow data for that area. Map
          data shown is the tarffic count for all motor vehicles.
        </Typography>
        <FormControl className={classes.formControl}>
        ...
        <Typography variant='body2'>
          To do: add direction filters and map indicators for direction
        </Typography>
        <Typography variant='body2'>
          To do: check data source paging to ensure all data shown
        </Typography>
        <br />
        <Button
          color='primary'
          variant='outlined'
          onClick={() => this.props.getAverageDailyFlow()}
        >
          Refresh data
        </Button>
        <br />
        {traffic_points.length > 0 ? (
          <React.Fragment>
            <ListSubheader>
              Charts: Annual Average Daily Flow By Direction
            </ListSubheader>
            <Divider />
            <HorizontalBar
              data={data_setup}
